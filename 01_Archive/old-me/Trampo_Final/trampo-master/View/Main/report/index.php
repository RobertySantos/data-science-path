    ...
    <main style="padding-top: 4em;">
        ...
        <section class="section-hire">
            ...
            <div class="z-depth-1 padding container-extended">
                ...
                <form action="../../../Controller/claimsReport.php?occupation_subcategory=<?php echo $_GET['occupation_subcategory']; ?>&id_service=<?php echo $_GET['id_service']?>" method = "POST" class="row">
                    <div class="input-field col s12">
                        <select name = "title">
                            <option value="" disabled selected>Escolha o assunto</option>
                            <option value="Serviço Não Realizado">Serviço Não Realizado</option>
                            <option value="Serviço Inclompleto">Serviço Inclompleto</option>
                            <option value="Pagamento Não Realizado">Pagamento Não Realizado</option>
                            <option value="Pagamento Incompleto">Pagamento Incompleto</option> 
                        </select>
                        <label>Assunto</label>
                    </div>
                    <div class="input-field col s12">
                    ...
                    <div class="input-field col s12 right-align">
                        <button action="../../../Controller/claimsReport.php?id_user=<?php echo $_GET['id_user']?>&occupation_subcategory=<?php echo $_GET['occupation_subcategory']; ?>&id_service=<?php echo $_GET['id_service']?>" method = "POST" class="btn waves-effect waves-light red darken-2">
                            Reportar
