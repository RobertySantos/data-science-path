                    ...
                    <div class="col s12 m7 offset-m1">
                        ...
                        <div class="row" style="margin-top:2em">
                            <div class="col s12">
                                ...
                                <a href="../report/?id_user=<?php echo $_GET['id_user']?>&occupation_subcategory=<?php echo $_GET['occupation_subcategory']; ?>&id_service=<?php echo $_GET['id_service']?>" class="btn red darken-4 waves-effect waves-light tooltipped"
